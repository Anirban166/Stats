...
$\therefore$ With the mean of a sample size of 100 bottles ($n = 100$), the probability of the selected bottles to be within 1ml ($\pm$) of the mean ($\mu =298$) is a hundred percent. (calculated value will be ~1)
